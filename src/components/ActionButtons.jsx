    ...
    <div className="md:absolute md:right-0 md:bottom-2 md:p-2 flex flex-col md:flex-row  justify-between md:gap-2">
      <div className="flex md:gap-2 w-full max-md:h-12 justify-end  md:px-4">
        <button
          ...
          className={cn(`${!user ? "hover:bg-none bg-gray-300/50" : ""}`,`flex items-center justify-center gap-2 max-middle:w-1/4 px-3 md:px-4 py-2 rounded-md text-sm font-medium transition-colors duration-300 max-md:rounded-none ${
            isFavorite
