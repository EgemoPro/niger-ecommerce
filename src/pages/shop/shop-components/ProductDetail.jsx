    ...
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <h1 className="text-3xl font-bold text-secondary-foreground">{product.name}</h1>
          ...
          <div className="flex items-center">
            ...
            <span className="ml-3 text-sm font-medium bg-green-100 text-green-800 px-2 py-1 rounded">-13%</span>
          </div>
