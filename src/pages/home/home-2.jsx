...
import EnhancedSection from "./sections/enhanced-section";
    ...
    >
      ...
      >
        ...
        style={{
          ...
          className="text-center h-screen border"
        >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center space-x-4 mt-6">
            <motion.div whileHover={{ scale: 1.2 }}>
              <FacebookIcon className="w-6 h-6 text-blue-400 hover:text-blue-600 cursor-pointer" />
            </motion.div>
            <motion.div whileHover={{ scale: 1.2 }}>
              <LinkedinIcon className="w-6 h-6 text-blue-400 hover:text-blue-600 cursor-pointer" />
            </motion.div>
            <motion.div whileHover={{ scale: 1.2 }}>
              <InstagramIcon className="w-6 h-6 text-pink-400 hover:text-pink-600 cursor-pointer" />
            </motion.div>
          </div>
        </div>
      </footer>
